...
export const meta: MetaFunction = () => ({
  title: 'Anisur Rahman | Blog',
  description: 'Blogs written by Anisur Rahman on Dev.to',
  'twitter:title': 'Anisur Rahman | Blog',
  'twitter:description': 'Blogs written by Anisur Rahman on Dev.to',
  'og:title': 'Anisur Rahman | Blog',
  'og:description': 'Blogs written by Anisur Rahman on Dev.to',
})
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        ...
        <a
          href="https://dev.to/anisurrahmann"
          target="_blank"
          rel="noopener noreferrer"
